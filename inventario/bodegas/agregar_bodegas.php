...
<h2 style='font-family:Segoe UI;'>➕ Agregar a <?= 'bodegas' ?></h2>

<form action='guardar_bodegas.php' method='POST' style='max-width:600px; margin:auto; background:#f9f9f9; padding:20px; border-radius:12px; box-shadow:0 0 10px rgba(0,0,0,0.05);'>

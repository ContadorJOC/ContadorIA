<?php
$nivel = '../../'; // Nivel correcto desde /nomina/novedades/
session_start();
...
$id = $_GET['id'];
$dato = $conexion->query("SELECT * FROM novedades WHERE id = $id")->fetch(PDO::FETCH_ASSOC);
...
<form action="guardar_novedades.php?id=<?= $id ?>" method="POST">
